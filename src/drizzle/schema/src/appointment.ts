import { pgTable, uuid, varchar, boolean, pgEnum, integer, decimal, timestamp, jsonb } from "drizzle-orm/pg-core";
...
export const appointment = pgTable('appointments', {
  ...
  datetime_start: timestamp('datetime_start'),
  datetime_end: timestamp('datetime_end'),
